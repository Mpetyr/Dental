      ...
      <div role="tabpanel" class="tab-pane" id="consulta">
        <form id="FormHistoriaMovimientoPacienteConsulta" action="<?= base_url('historia/movimiento/guardarPacienteConsulta') ?>" method="post">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="algunaVezMedicamentoTexto" class="form-control input-sm" rows="2"><?= $consulta->ortodtexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="tomandoMedicamentoTexto" class="form-control input-sm" rows="2"><?= $consulta->medictexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="alergicoAnestesicoTexto" class="form-control input-sm" rows="2"><?= $consulta->alergicotexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="hospitalizadoCirugiaTexto" class="form-control input-sm" rows="2"><?= $consulta->hosptexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="transtornoNerviosoEmocionalTexto" class="form-control input-sm" rows="2"><?= $consulta->transtexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="cepillaDientesTexto" class="form-control input-sm" rows="2"><?= $consulta->cepillatexto_paccon ?></textarea>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="form-group">
                <textarea name="presionArterialTexto" class="form-control input-sm" rows="2"><?= $consulta->presiontexto_paccon ?></textarea>
              </div>
            </div>
          </div>
            <div class="row">
